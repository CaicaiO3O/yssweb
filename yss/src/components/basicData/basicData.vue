      ...
      <div class="part-1">
        ...
        <el-form :model="form_1" :rules="rules" ref="form_1" label-width="120px" :inline-message='true'>
          ...
          <el-form-item label="所在医院" prop="fkHospitalId" >
            <el-select placeholder="请选择" v-model="form_1.memberProvince" style="width: 131px;" @change="getCityByProvince(form_1.memberProvince)">
              <el-option v-for="item in province_options" :label="item.provinceName" :value="item.provinceId" :key="item.provinceId"></el-option>
            </el-select>
            <el-select placeholder="请选择" v-model="form_1.memberCity" style="width: 131px;" @change = "getDistrictByCity(form_1.memberProvince,form_1.memberCity)">
              <el-option v-for="item in city_options" :key="item.cityId" :label="item.cityName" :value="item.cityId"></el-option>
            </el-select>
            <el-select placeholder="请选择" v-model="form_1.fkDistrictId" style="width: 130px;">
              <el-option v-for="item in region_options" :key="item.id" :label="item.name" :value="item.id"></el-option>
            </el-select>
            <br>
            <el-select placeholder="请选择" style="width: 400px;margin-top: 10px;" v-model="form_1.fkHospitalId" @change="changeHospital(form_1.fkHospitalId)">
            ...
            <br />
            <el-input style="width: 400px;margin-top: 10px;" v-if="form_1.fkHospitalId == 0" v-model="form_1.inputhospital"></el-input>
          </el-form-item>
          <el-form-item label="工作科室" prop="membersectionoffice">
            <el-select v-model="form_1.hospital_departments_1" style="width: 198px;" @change="getSonOffice(form_1.hospital_departments_1)">
            ...
            <el-select v-model="form_1.membersectionoffice" style="width: 198px;">
          ...
          <el-form-item label="职称" prop="memberstation">
            <el-select v-model="form_1.zc_1" @change = "getStationTechnicalTitle(form_1.zc_1)" style="width: 198px;">
              <el-option v-for="item in zc_1_options" :value="item.stationId" :key="item.stationId" :label="item.stationName"></el-option>
            </el-select>
            <el-select v-model="form_1.memberstation" style="width: 198px;">
          ...
          <el-form-item label="行政职位" prop="administrativeposition">
            <el-select v-model="form_1.administrativeposition" style="width: 200px;">
        ...
        <el-form :model="form_2" :rules="rules" ref="form_2" label-width="120px" :inline-message='true'>
          <el-form-item label="您的性别" prop="memberSex">
            <el-radio-group v-model="form_2.memberSex">
          ...
          <el-form-item label="最高学历" prop="memberEducation">
            <el-select v-model="form_2.memberEducation" style="width: 200px;">
          ...
          <el-form-item label="毕业时间" required prop="graduationTime">
            <el-date-picker v-model="form_2.graduationTime" type="year" placeholder="选择日期" value-format="yyyy" style="width: 200px;"></el-date-picker>
          </el-form-item>
          <el-form-item label="毕业院校" prop="graduationInstitutions">
            <el-select placeholder="请选择省份" v-model="form_2.province" @change="getGraduateList(form_2.province)">
              <el-option v-for="item in province_options" :label="item.provinceName" :key="item.provinceId" :value="item.provinceId"></el-option>
            </el-select>
            <el-select placeholder="请选择学校" v-model="form_2.graduationInstitutions">
