<template>
  <footer id="footer">
    <div class="yss-info">
      <div class="part-1">
        ...
        <ul>
          ...
          <li @click="tointegrationUse">积分中心</li>
    ...
    <div class="copyright">Copyright &#169 2000-2018 All rights reserved 版权所有 医生说 - 中国第一医生调查网站 未经授权请勿转载</div>
    <div class="recordation">沪ICP备10019317号-8</div>
  </footer>
</template>
...
<script>
  export default {
    ...
    methods: {
      toinvestgationProject(){
        this.$router.push('/investgationProject');
      },
      tointegrationUse(){
