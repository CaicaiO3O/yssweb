    ...
    <div class="intr-wrapper">
      <div class="yss-intr">
        ...
        <div class="intr-main">
          ...
          <div class="yss-txt">
            <p>医生说为英德知联恒市场咨询（上海）有限公司所有的线上医学调查网站。我 们的服务范围超过 100 个国家，提供市场动态与消费者态度与行为的市场调查与分 析服务。</p>
            <p>在中国，我们收集并分析消费者购物的行为已超过 8年。从 05年成立至今我们 已携手 IMS Health 、尼尔森、KANTAR HEALTH、Ipsos等全球知名调研公司开展 了大量医学市场调查，调研涉及疾病诊治、医疗器械使用需求及改进、 医药品牌满 意度、 医生职业满意度、 跨国药企学术营销、医学再教育情况等几大方面。</p>
            <p>部分调查结果汇同其他国家的数据一并分析，为医药企业产品、服务改进、 卫生健康决策制定提供来自临床一线医生的数据支持。</p>
          </div>
        </div>
      </div>
    </div>
